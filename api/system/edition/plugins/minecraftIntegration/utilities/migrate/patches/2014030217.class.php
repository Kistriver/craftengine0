<?php
namespace CRAFTEngine\plugins\users\utilities\migrate;
/**
 * @package core
...
class patch_2014030217
{
	protected $core;

	const VER = 2014030217;
	...
	public function set()
	{
		...
		if(!$this->core->utilities->system->migrate->markAsInstalled('minecraft_integration',self::VER))
		return false;
